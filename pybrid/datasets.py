...
class SharedMNIST(datasets.MNIST):
    def __init__( self, train, path="./data", size=None, scale=None, normalize=False, labels=None, flatten=False, return_one_hot=False):
        transform = _get_transform(normalize=normalize, mean=0.1307, std=0.3081)
        super().__init__(root=path, train=train, download=False, transform=transform)
